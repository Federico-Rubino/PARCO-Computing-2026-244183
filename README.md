...
The CSV file begin with three commented header lines (prefixed with # so remember to use pd.read_csv('log.csv', comment="#") in Pandas) that provide useful information about the simulations:
```
